...
def getLinkedmdbResource (label, lang, endpoint):
	...
	if (lang):
		queryString = "PREFIX movie: <http://data.linkedmdb.org/resource/movie/> PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> PREFIX foaf: <http://xmlns.com/foaf/0.1/> SELECT ?m WHERE { ?m rdfs:label \"" + label + "\"@" + lang + " . ?m rdf:type movie:film }"
